...
export default function UntraditionalCarousel2() {
    ...
    return (
        <div className="min-h-screen bg-purple-800 overflow-y-hidden mt-96 pt-96">
            <motion.div
                ...
                <UntraditionalCarousel titles={titles && titles}>
                    {titles && titles.map((e: any) => (
                        <CarouselItem key={e}>
                            <div className="whitespace-normal grid grid-cols-3 place-content-center place-items-center max-w-7xl mt-24 md:-mt-36">
